...
import './log-in-and-buy.css'

const LogInAndBuy = (props) => {
  return (
    <div className="log-in-and-buy-container">
      <Helmet>
        <title>Log-in-and-Buy - Blocking</title>
        <meta property="og:title" content="Log-in-and-Buy - Blocking" />
      </Helmet>
      <div className="log-in-and-buy-hero">
        <div className="log-in-and-buy-fixed-header">
          <Header rootClassName="header-root-class-name"></Header>
        </div>
        <h1 className="log-in-and-buy-text Text2XL">
          Miami Beah is looking different at night!
        </h1>
        <div className="log-in-and-buy-bg"></div>
      </div>
      <div className="log-in-and-buy-post-details">
        <div className="log-in-and-buy-container01">
          <svg
            viewBox="0 0 1170.2857142857142 1024"
            className="log-in-and-buy-icon"
          >
        ...
        <span className="log-in-and-buy-text01 TextXL">
          posted 18 Sept 2021
        </span>
        <span className="log-in-and-buy-text02">
          <span className="log-in-and-buy-text03">
            &apos;Started from the bottom now we here&apos;
          </span>
          <span className="log-in-and-buy-text04">
            -
            <span
          ...
          <span className="log-in-and-buy-text05">Mark Jonson</span>
          <br></br>
        </span>
        <span className="log-in-and-buy-text06">
          <span className="log-in-and-buy-text07">
      ...
      <div className="log-in-and-buy-container02">
        <div className="log-in-and-buy-story">
          <span className="log-in-and-buy-text08 TextLG">
            <span>March 1, 2019</span>
          </span>
          <h3 className="log-in-and-buy-text10 Text2XL">
            The Castle Looks Different at Night...
          </h3>
          <img
            alt="image"
            src="/new-york-city-1400w.jpg"
            className="log-in-and-buy-image"
          />
          <span className="log-in-and-buy-text11 TextLG">
            <span className="log-in-and-buy-text12">
            ...
            <span></span>
            <br></br>
            <span className="log-in-and-buy-text15">
          ...
          <div className="log-in-and-buy-container03">
            <span className="TextLG">
              <span className="log-in-and-buy-text17">&quot;</span>
              <span className="log-in-and-buy-text18">
                And thank you for turning my personal jean jacket into a couture
                piece.
              </span>
              <span className="log-in-and-buy-text19">&quot;</span>
            </span>
            <span className="log-in-and-buy-text20">
              <span className="log-in-and-buy-text21">
                Kanye West, Producer.
              </span>
              <span className="log-in-and-buy-text22"></span>
            </span>
          </div>
          <h3 className="log-in-and-buy-text23 Text2XL">
            Using Video Games To Generate Clicks
          </h3>
          <span className="log-in-and-buy-text24 TextLG">
            <span className="log-in-and-buy-text25">
              This is the paragraph where you can write more details about your
              product. Keep you user engaged by providing meaningful
              information. Remember that by this time, the user is curious,
              otherwise he wouldn&apos;t scroll to get here. Add a button if you
          ...
          <img
            ...
            className="log-in-and-buy-image1"
          />
          <h3 className="log-in-and-buy-text26 Text2XL">Rest of the Story</h3>
          <span className="log-in-and-buy-text27 TextLG">
            <span className="log-in-and-buy-text28">
            ...
            <span></span>
            <br></br>
            <span className="log-in-and-buy-text31">
            ...
            <span></span>
            <br></br>
            <span className="log-in-and-buy-text34">
          ...
          <div className="log-in-and-buy-post">
            <span className="log-in-and-buy-text35 TextXL">
              What people say...
            </span>
            <div className="log-in-and-buy-divider"></div>
            <div className="log-in-and-buy-container04">
              <div className="log-in-and-buy-container05">
                <img
                  alt="image"
                  src="/team5-1400w.jpg"
                  className="log-in-and-buy-image2"
                />
                <div className="log-in-and-buy-container06">
                  <span className="log-in-and-buy-text36 TextSM">
                    JOHN SNOW
                  </span>
                  <div className="log-in-and-buy-container07">
                    <span className="log-in-and-buy-text37 TextXS">
                      3 days ago
                    </span>
                  </div>
                </div>
            ...
            <span className="log-in-and-buy-text38 TextMD">
              <span className="log-in-and-buy-text39">
            ...
            <img
              alt="image"
              src="/new-york-city-1400w.jpg"
              className="log-in-and-buy-image3"
            />
            <div className="log-in-and-buy-container08">
              <div className="log-in-and-buy-container09">
                <svg viewBox="0 0 1024 1024" className="log-in-and-buy-icon2">
                ...
                <span className="log-in-and-buy-text40 TextXS">150</span>
                <svg viewBox="0 0 1024 1024" className="log-in-and-buy-icon4">
                ...
                <span className="log-in-and-buy-text41 TextXS">36</span>
                <svg viewBox="0 0 1024 1024" className="log-in-and-buy-icon6">
                ...
                <span className="log-in-and-buy-text42 TextXS">12</span>
              </div>
              <div className="log-in-and-buy-container10">
                <img
                  alt="image"
                  src="/team5-1400w.jpg"
                  className="log-in-and-buy-image4"
                />
                <img
                  alt="image"
                  src="/team6-200h.jpg"
                  className="log-in-and-buy-image5"
                />
                <img
                  alt="image"
                  src="/team1-200h.jpg"
                  className="log-in-and-buy-image6"
                />
                <span className="log-in-and-buy-text43 TextXS">
                  and 30+ more
                </span>
              </div>
            </div>
            <div className="log-in-and-buy-divider1"></div>
            <span className="log-in-and-buy-text44 TextSM">Load previous</span>
            <PostReaction
              name="Michael Lewis"
              likes="3"
            ...
            ></PostReaction>
            <span className="log-in-and-buy-text45 TextSM">Load next</span>
            <div className="log-in-and-buy-container11">
              <img
                alt="image"
                src="/team21-200h.jpg"
                className="log-in-and-buy-image7"
              />
              <textarea
                rows="1"
                placeholder="Write your comment"
                className="log-in-and-buy-textarea textarea TextSM"
              ></textarea>
            </div>
          </div>
        </div>
      </div>
      <div className="log-in-and-buy-posts">
        <div className="log-in-and-buy-container12">
          <Label text="STORIES"></Label>
          <h3 className="log-in-and-buy-text46 Healine">
            <span className="log-in-and-buy-text47">Before I go </span>
          </h3>
          <span className="log-in-and-buy-text48 TextXL">
